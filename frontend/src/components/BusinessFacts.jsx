...
function BusinessFacts() {
  return (
    <div className="md:container md:mx-auto px-5 my-20">
      <div className="flex justify-center flex-col items-center">
        ...
        <ul className="flex lg:flex-row flex-col gap-5 justify-center ">
          <div className="flex gap-x-5">
            <li className="bg-white shadow-sm rounded-lg p-7 md:p-10 flex justify-center items-center flex-col text-center md:w-[220px] flex-[1]">
          ...
          <div className="flex gap-x-5">
            ...
            <li className="bg-white shadow-sm rounded-lg p-7 md:p-10 flex justify-center items-center flex-col md:w-[200px] flex-[1]">
