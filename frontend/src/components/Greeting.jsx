...
function Greeting() {
  return (
    <div>
      <div className=" md:flex justify-center items-center hidden md:px-32 my-32">
        <div className="md:container md:mx-auto mx-5 md:min-h-[500px] flex md:flex-row flex-col shadow-lg rounded-lg overflow-hidden">
