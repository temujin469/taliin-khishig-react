...
function Subscribe() {
  return (
    <div className="flex md:px-4 flex-col-reverse md:flex-row items-center justify-center md:container md:mx-auto my-10">
      <div className="w-[80%] md:w-[60%]">
        <div className="bg-white shadow-md relative mt-[-80px] md:static md:mt-0 md:mx-0 rounded-lg overflow-hidden p-8 sm:p-14 lg:pr-40">
      ...
      <img
        ...
        className="md:relative px-4 md:px-0 md:mt-0 md:ml-[-120px] md:hidden lg:block md:max-w-[30%] h-full"
      />
    </div>
  );
}
